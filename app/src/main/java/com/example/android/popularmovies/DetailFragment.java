...
public class DetailFragment extends Fragment {
    ...
    private CardView mTrailerCardview;
                            ...
                            if (isFavorited == 1){
                                ...
                                new AsyncTask<Void, Void, Uri>(){
                                    ...
                                    protected Uri doInBackground(Void... params){
                                        ...
                                        values.put(MoviesData.MovieEntry.COLUMN_MOVIE_ID, mMovie.getId());
                                        values.put(MoviesData.MovieEntry.COLUMN_TITLE, mMovie.getTitle());
                                        values.put(MoviesData.MovieEntry.COLUMN_IMAGE, mMovie.getImage());
                                        values.put(MoviesData.MovieEntry.COLUMN_IMAGE2, mMovie.getImage2());
                                        values.put(MoviesData.MovieEntry.COLUMN_DATE, mMovie.getDate());
                                        values.put(MoviesData.MovieEntry.COLUMN_DESC, mMovie.getDescription());
                                        values.put(MoviesData.MovieEntry.COLUMN_RATE, mMovie.getRate());

                                        return getActivity().getContentResolver().insert(MoviesData.MovieEntry.CONTENT_URI, values);
                                    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTrailerCardview = (CardView) rootView.findViewById(R.id.detail_trailers_cardview);
        ...
        if (mMovie != null){
            ...
            mOverviewView.setText(mMovie.getDescription());
            ...
            mVoteAverageView.setText(Integer.toString(mMovie.getRate()));
        }
